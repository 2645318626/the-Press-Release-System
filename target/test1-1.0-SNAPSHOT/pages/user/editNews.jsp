...
<head>
    ...
    <link rel="stylesheet" href="static/css/newspages.css" type="text/css">
</head>
<body>
                        ...
                        <table id="showTable">
                            ...
                            <c:forEach items="${requestScope.list}" var="news" varStatus="status">
                                <tr>
                                    ...
                                    <td>${news.getType()}</td>
                                    <td class="overEllipsis item" title="${news.getTitle()}">${news.getTitle()}</td>
                                    <td>${news.getGetDate()}</td>
                                    <td>
                                        <a href="newsServlet?action=showNews&from=querySingleById&id=${news.getId()}"
                                           class="editBtn" id="alterBtn">编辑</a>
                                        <a href="newsServlet?action=detailNews&id=${news.getId()}&from=user"
